...
a.box:focus,
a.box:hover {
    box-shadow: 0 .5em 1em -.125em rgba(10, 10, 10, .1), 0 0 0 1px #6d90d6
}

a.box:active {
    box-shadow: inset 0 1px 2px rgba(10, 10, 10, .2), 0 0 0 1px #6d90d6
}
...
.button.is-primary:focus:not(:active) {
    box-shadow: 0 0 0 .125em rgba(106, 191, 176, .25)
}
...
.button.is-info:focus:not(:active) {
    box-shadow: 0 0 0 .125em rgba(108, 195, 213, .25)
}
...
.button.is-success:focus:not(:active) {
    box-shadow: 0 0 0 .125em rgba(86, 204, 144, .25)
}
...
.button.is-warning:focus:not(:active) {
    box-shadow: 0 0 0 .125em rgba(255, 206, 103, .25)
}
...
.button.is-danger:focus:not(:active) {
    box-shadow: 0 0 0 .125em rgba(238, 161, 112, .25)
}
...
.file.is-primary:focus .file-cta {
    border-color: transparent;
    box-shadow: 0 0 .5em rgba(106, 191, 176, .25);
    color: #fff
}
...
.file.is-info:focus .file-cta {
    border-color: transparent;
    box-shadow: 0 0 .5em rgba(108, 195, 213, .25);
    color: #fff
}
...
.file.is-success:focus .file-cta {
    border-color: transparent;
    box-shadow: 0 0 .5em rgba(86, 204, 144, .25);
    color: #fff
}
...
.file.is-warning:focus .file-cta {
    border-color: transparent;
    box-shadow: 0 0 .5em rgba(255, 206, 103, .25);
    color: rgba(0, 0, 0, .7)
}
...
.file.is-danger:focus .file-cta {
    border-color: transparent;
    box-shadow: 0 0 .5em rgba(238, 161, 112, .25);
    color: #fff
}
...
.button:active,
.button:focus {
    box-shadow: 0 0 0 2px rgba(109, 144, 214, .25)
}
...
.button.is-black:focus {
    border-color: #0a0a0a;
    box-shadow: 0 0 0 2px rgba(10, 10, 10, .25)
}
...
.button.is-light:focus {
    border-color: #f5f5f5;
    box-shadow: 0 0 0 2px rgba(245, 245, 245, .25)
}
...
.button.is-dark:focus {
    border-color: #363636;
    box-shadow: 0 0 0 2px rgba(54, 54, 54, .25)
}
...
.button.is-primary:focus {
    border-color: #6abfb0;
    box-shadow: 0 0 0 2px rgba(106, 191, 176, .25)
}
...
.button.is-info:focus {
    border-color: #6cc3d5;
    box-shadow: 0 0 0 2px rgba(108, 195, 213, .25)
}
...
.button.is-success:focus {
    border-color: #56cc90;
    box-shadow: 0 0 0 2px rgba(86, 204, 144, .25)
}
...
.button.is-warning:focus {
    border-color: #ffce67;
    box-shadow: 0 0 0 2px rgba(255, 206, 103, .25)
}
...
.button.is-danger:focus {
    border-color: #eea170;
    box-shadow: 0 0 0 2px rgba(238, 161, 112, .25)
}
