...
a.box:focus,
a.box:hover {
    box-shadow: 0 .5em 1em -.125em rgba(10, 10, 10, .1), 0 0 0 1px #5bb7db
}

a.box:active {
    box-shadow: inset 0 1px 2px rgba(10, 10, 10, .2), 0 0 0 1px #5bb7db
}
...
.button:focus:not(:active) {
    box-shadow: 0 0 0 .125em rgba(91, 183, 219, .25)
}
...
.button.is-primary:focus:not(:active) {
    box-shadow: 0 0 0 .125em rgba(21, 140, 186, .25)
}
...
.button.is-success:focus:not(:active) {
    box-shadow: 0 0 0 .125em rgba(40, 182, 44, .25)
}
...
.button.is-danger:focus:not(:active) {
    box-shadow: 0 0 0 .125em rgba(255, 65, 54, .25)
}
...
.file.is-primary:focus .file-cta {
    border-color: transparent;
    box-shadow: 0 0 .5em rgba(21, 140, 186, .25);
    color: #fff
}
...
.file.is-link:focus .file-cta {
    border-color: transparent;
    box-shadow: 0 0 .5em rgba(91, 183, 219, .25);
    color: #fff
}
...
.file.is-success:focus .file-cta {
    border-color: transparent;
    box-shadow: 0 0 .5em rgba(40, 182, 44, .25);
    color: #fff
}
...
.file.is-danger:focus .file-cta {
    border-color: transparent;
    box-shadow: 0 0 .5em rgba(255, 65, 54, .25);
    color: #fff
}
...
.input,
.textarea {
    box-shadow: inset 0 .125em 0 rgba(10, 10, 10, .075)
}
...
.textarea:active,
.textarea:focus {
    box-shadow: inset 0 .125em 0 rgba(10, 10, 10, .075), 0 0 0 .125em rgba(91, 183, 219, .25)
}
...
.textarea.is-white:focus {
    border-color: #e6e6e6;
    box-shadow: inset 0 .125em 0 rgba(10, 10, 10, .075), 0 0 0 .125em rgba(255, 255, 255, .25)
}
...
.textarea.is-black:focus {
    border-color: #000;
    box-shadow: inset 0 .125em 0 rgba(10, 10, 10, .075), 0 0 0 .125em rgba(10, 10, 10, .25)
}
...
.textarea.is-light:focus {
    border-color: #dbdbdb;
    box-shadow: inset 0 .125em 0 rgba(10, 10, 10, .075), 0 0 0 .125em rgba(245, 245, 245, .25)
}
...
.textarea.is-dark:focus {
    border-color: #1c1c1c;
    box-shadow: inset 0 .125em 0 rgba(10, 10, 10, .075), 0 0 0 .125em rgba(54, 54, 54, .25)
}
...
.textarea.is-primary:focus {
    border-color: #106a8c;
    box-shadow: inset 0 .125em 0 rgba(10, 10, 10, .075), 0 0 0 .125em rgba(21, 140, 186, .25)
}
...
.textarea.is-info:focus {
    border-color: #207dbc;
    box-shadow: inset 0 .125em 0 rgba(10, 10, 10, .075), 0 0 0 .125em rgba(50, 152, 220, .25)
}
...
.textarea.is-success:focus {
    border-color: #1f8c22;
    box-shadow: inset 0 .125em 0 rgba(10, 10, 10, .075), 0 0 0 .125em rgba(40, 182, 44, .25)
}
...
.textarea.is-warning:focus {
    border-color: #ffd324;
    box-shadow: inset 0 .125em 0 rgba(10, 10, 10, .075), 0 0 0 .125em rgba(255, 221, 87, .25)
}
...
.textarea.is-danger:focus {
    border-color: #ff1103;
    box-shadow: inset 0 .125em 0 rgba(10, 10, 10, .075), 0 0 0 .125em rgba(255, 65, 54, .25)
}
...
.card {
    box-shadow: none;
    border-color: #dbdbdb;
    background-color: rgba(219, 219, 219, .075);
    border-radius: 4px
}
